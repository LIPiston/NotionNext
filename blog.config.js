...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LIPiston', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '尝试抓住自己的思维', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.lipiston.eu.org/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'LIPiston, lipiston, blog, 博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，欢迎来到我的博客！,Hello,Welcome to my blog!',
